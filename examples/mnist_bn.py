...
from lasagne.layers.bn2 import BatchNormLayer2 as BN
...
def build_model(input_dim, output_dim,
    ...
    l_hidden1 = BN(lasagne.layers.DenseLayer(
        l_in,
    ...
    l_hidden2 = BN(lasagne.layers.DenseLayer(
        l_hidden1_dropout,
        num_units=num_hidden_units,
        nonlinearity=lasagne.nonlinearities.identity,
        ))
    ...
    l_out = BN(lasagne.layers.DenseLayer(
        l_hidden2_dropout,
...
def create_iter_functions(dataset, output_layer,
    ...
    for l in lasagne.layers.get_all_layers(output_layer):
        if hasattr(l, 'pre_train'):
            updates += l.get_additional_updates()
